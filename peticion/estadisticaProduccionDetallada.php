...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="rg_bitacora" action="controlador/estadisticoProduccionDetallada_controller.php" method="post" >
                <h3 class="text-center"> ESTADISTICO <small> PRODUCCION DETALLADO</small></h3>
