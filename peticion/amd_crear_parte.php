...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_rg_seccion" action= "../controlador/amdCrearParte_controller.php"   method="post" >
                <h3 class="text-center"> REGISTRO PARTE <small>EQUIPO</small></h3>

                <div class="form-group">

                    
                    <input type="text" class="form-control alphaNumber"  name="parte"    placeholder="Nobre Parte" required autofocus/>
