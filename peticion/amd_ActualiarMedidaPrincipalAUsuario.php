...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
            ...
            <form role="form" id="amd_maquina_origen" action="../controlador/amdActualizarMedidaPrincipalAMaquina_controller.php"  method="post" >
                <h3 class="text-center"> ACTUALIZAR MEDIDA PRINCIPAL DE <small>MAQUINA</small></h3>
