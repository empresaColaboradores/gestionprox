...
<div class="container">
    <div class=" row">
        <form role="form" id="rg_bitacora" action="controlador/registrarTiempoImproductivo_diferenteDia_controller.php" method="post" >
            <h3 class="text-center"> PONER AL DIA LOS REGISTROS DE<small>PRODUCCION</small></h3>
