...
<head>
 ...
 <script language="javascript" src="../script/Bitacora_relacionarMaquinaSeccion.js"></script>         
...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_maquina_origen" action="../controlador/amdRelacionarSeccionMaquina_controller.php"  method="post" >
                <h3 class="text-center"> RELACIONAR  MAQUINA  <small>SECCION</small></h3>
