...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_find" action= "../controlador/amd_find_Usuario_controller.php"  method="post" >
                <h3 class="text-center"> LISTADO USUARIOS <small>REGISTRADO</small></h3>
