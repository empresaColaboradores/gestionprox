...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_maquina_origen_causa" action="../controlador/amdFindOrigenCausaMaquina_controller.php"  method="post" >
                <h3 class="text-center"> LISTAR CAUSA Y TIPO <small>TIEMPO IMPRODUCTIVO</small></h3>
