...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
            ...
            <form role="form" id="amd_maquina_origen" action="../controlador/amdBuscarMedidaSecundarialAMaquina_controller.php"  method="post" >
                <h3 class="text-center"> BUSCAR MEDIDA DE PRODUCCION <small>SECUNDARIA </small></h3>
