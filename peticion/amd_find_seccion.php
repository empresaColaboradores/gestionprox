...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_rg_seccion" action= "../controlador/amdFindSeccion_controller.php"   method="post" >
                <h3 class="text-center"> BUSCAR  <small>SECCION</small></h3>
                
                
                <div class="form-group">

                    
                    <input type="text" class="form-control onlyNumbers"  name="id"    placeholder="Id Seccion"  autofocus/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control alphaNumber"  name="seccion"    placeholder="Nobre Seccion de la Maquina" />
