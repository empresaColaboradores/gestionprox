...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_usuario_maquina" action="../controlador/amdEliminarRelacionOperadorMaquina_controller.php"  method="post" >
                <h3 class="text-center">ELIMINAR RELACION  MAQUINA <small>OPERADOR</small></h3>
                ...
                <div class="form-group">
                    ...
                    <select id="eliminar_operador" name="operador" class="form-control">
                        <option value="0">Selecciona Uno...</option>
                    </select>
                </div>
