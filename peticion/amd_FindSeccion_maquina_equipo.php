...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_maquina_origen" action="../controlador/amdFindMaquinaSeccionEquipo_controller.php"  method="post" >
                <h3 class="text-center"> LISTAR  <small>MAQUINA-SECCION-EQUIPO-PARTE</small></h3>
