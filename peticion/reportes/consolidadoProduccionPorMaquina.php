...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="rg_bitacora" action="controlador/reportes/estadisticoProduccionResumida_controller.php" method="post" >
                <h3 class="text-center"> CONSOLIDADO PRODUCCION <small> POR MAQUINAS</small></h3>
