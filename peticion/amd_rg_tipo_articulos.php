...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_rg_tipo_articulo" action= "../controlador/amdCrearTipoArticulo_controller.php" method="post" >
                <h3 class="text-center"> REGISTRO TIPO <small>PRODUCTOS</small></h3>

                <div class="form-group" >

                    <input type="text"  class="form-control " name="codigo" size="40" maxlength="20"   placeholder="Codigo de Producto" required autofocus/>
                ...
                <div class="form-group" >
                    ...
                    <input type="tex"  class="form-control " name="nombre_tipo_articulo" size="40" maxlength="40"   placeholder="Nombre Tipo de Articulo"required/>
                ...
                <div class="form-group" >
                    ...
                    <input type="tex"  class="form-control " name="cantidad_pp" size="40" maxlength="40"  id="refP"  placeholder="Cantidad minima permitida en Pedidos"required/>
