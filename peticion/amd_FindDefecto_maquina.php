...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_maquina_origen" action="../controlador/amdfindOrigenMaquina_controller.php"  method="post" >
                <h3 class="text-center"> LISTAR DEFECTOS POR  <small>MAQUINA-ORIGEN</small></h3>
