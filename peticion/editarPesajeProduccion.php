...
<div class="page-header text-center">
    <h1> <small>EDITAR REPORTE DE PRODUCCION</small></h1>
...
<div class="container">
    <div class=" row">
        <form role="form" id="registroProduccion_xyz" action="controlador/editarPesajeProduccion_controller.php" method="post" >
            ...
            <div class="col-md-3 ol-md-offset-2" >
                ...
                <div class="form-group">
                    ...
                    <input type="text"  id="op" class="form-control form-inline onlyNumbers"  maxlength="20" name="op" required placeholder="Orden Produccion" value=" <?php echo $id_op;?>">
                    <input type="hidden"    name="consecutivo"  value=" <?php echo $id_consecutivo;?>">
            ...
            <div class="col-md-3 ol-md-offset-2" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-inline onlyNumbers"  maxlength="7" name="kilos" required placeholder="<?php $formulario->getText(); ?>" value ="<?php echo $kilosUnidades_producidos;?>">
               ...
               <!-- dinamico -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fecha" class="form-control " placeholder="aaaa-mm-dd" value="<?php echo $fecha;?>"/>
                </div>
