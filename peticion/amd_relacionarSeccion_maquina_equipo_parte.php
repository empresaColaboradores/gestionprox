...
<head>
 ...
 <script language="javascript" src="../script/admin.js"></script>    
  <script language="javascript" src="../script/Maquina_RMSEP.js"></script>  
...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_maquina_origen" action="../controlador/amdRelacionarMaquinaSeccionEquipoParte_controller.php"  method="post" >
                <h3 class="text-center"> RELACIONAR    <small>MAQUINA-SECCION-EQUIPO-PARTE</small></h3>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="exampleInputPassword1">Parte Equipo</label>
