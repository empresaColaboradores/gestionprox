...
<div class="container">
    <div class=" row">
        ...
        <div class="col-md-4">
          ...
          <form role="form" id="amd_usuario_maquina" action="../controlador/amdRelacionarOperadorMaquina_controller.php"  method="post" >
                <h3 class="text-center"> RELACIONAR  MAQUINA <small>OPERADOR</small></h3>
