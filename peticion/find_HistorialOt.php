...
<div class="col-md-4 ol-md-offset-4" > 
        ...
        <form role="form" id="find_timp" action="controlador/find_ot_historial.php" method="post" >
            <h3 class="text-center"> CONSULTA  HISTORIAL ORDEN DE TRABAJO <small>TRABAJO</small></h3>
