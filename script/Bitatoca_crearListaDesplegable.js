...
function cargarInputSegunUsuario(){
    
     $.get("controlador/Bitacora_Cargar_lista_desplegables.php?op=23",  function (resultado) {
        if (resultado == false)
        {
...
{
    var code = $("#maquina").val();
    $.get("controlador/Bitacora_Cargar_lista_desplegables.php?op=1", {code: code}, function (resultado) {
        if (resultado == false)
        {
...
function dependencia_origen()
{
    ...
    $.get("controlador/Bitacora_Cargar_lista_desplegables.php?op=4", {code: code, maquina: maquina},
    function (resultado)
    {
        if (resultado == false)
        {
