...
if (($operador->consultarRelacionOperadorMaquina()->num_rows) <= 0) {


    $operador->next_result();
    $operador->relacionOperadorMaquina();
    ...
    echo('<script>alert("el usuario ya esta registrado en esta maquina como operador")</script>');
    raiz_amd();
    exit();
}
?>
