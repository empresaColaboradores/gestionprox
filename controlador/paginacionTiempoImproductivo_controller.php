...
if (validar_user()) {
    ...
    $paginacion->setNumeroRegistros($bitacora->contarRegistroTimpoImpro($ficha, $op, $maquina, $operador, $origen, $causa, $detalle, $fecha_inicial, $fecha_final));
    ...
    $paginacion->setLinkPaginacion('paginacionTiempoImproductivo');
    ...
    $consulta = $bitacora->consultarHistorialTiempoImproductivoProduc($maquina, $operador, $origen, $causa, $detalle, $fecha_inicial, $fecha_final, $inicioLimite, $numeroPagina, $ficha, $op);
    ...
    require_once '../vista/MostrarHistorialTiempoImproductivo.php';
} else {
