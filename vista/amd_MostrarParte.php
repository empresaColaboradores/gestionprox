...
<div class="cointaner text-center"> 
        <div> 
            ...
            <button  class="btn btn-lg btn-primary " onClick="buscarPM()" title="Buscar Parte" type="submit"><span class="glyphicon glyphicon-search"></span> </button>
            <button type="button"  title="Relacionar Maquina-Seccion-Equipo-Parte"  onClick="relacionarMSEP()" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-indent-left"></span></button>
...
<div class="row"> <!-- row one -->
    ...
    <div class="col-md-12">
        ...
        <table class="table  table-bordered table-bordered ">
            ...
            <h3 class="text-center">LISTADO PARTE  <small> EQUIPO</small></h3>
