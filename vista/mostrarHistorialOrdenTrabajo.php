...
<div id="vista3">
    ...
    <div id="vista4"> </div>
     ...
     <div class="page-header">
                 <h1> <small> HISTORIAL ORDENES DE TRBAJO </small></h1>
    ...
    <div class="container">
        ...
        <div class="navbar-btn text-center">
            ...
            <form  class="form-signin"  method="post" action="controlador/historialOrdenDeTrabajoExportarExcell_controller.php?excel=excell"  role="form">
